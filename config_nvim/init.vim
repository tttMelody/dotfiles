...
au BufReadPre * if match(expand("%"), "nginx.conf") > 0 |set filetype=nginx |endif
...
let g:tagbar_sort = 1 "1 sort by position; 0 sort by tag name
...
let g:tagbar_type_typescript = {                                                  
  ...
  \ ],                                                                            
  \ 'sort' : 0,
  \ 'deffile' : '~/dotfiles/config_tagsystem/ctags_ts.cnf'
\ }                              
